...
class _MiningChartState extends State<MiningChart> {
  ...
  void getChartData() async {
    APIChartService minerChart = APIChartService();
    await minerChart.getMinerChart();
    miningList = minerChart.chartMining;
    setState(() {
      _loading = false;
    });
  }
  ...
  List<LineChartBarData> measurementsData(List<ChartMining> mlist) {
